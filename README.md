...
- **파일 탐색기 & 문서 뷰어** — 트리 탐색·업로드는 물론, PDF/DOCX/XLSX/PPTX/MSG 파일을 브라우저에서 바로 미리봅니다. DRM 문서는 로컬 MS Office COM 변환으로 처리하고, 텍스트 추출·제자리 편집 API를 제공합니다. (서버 PC에 MS Office가 설치되어야 합니다)
